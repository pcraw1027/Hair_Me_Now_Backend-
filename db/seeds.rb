...
ap1 = Appointment.create(date: Date.new(2021,06,22), time: Time.new(2021,06,22,11,0,0, "+00:00"), customer_id: ct1.id, stylist_id: sy1.id, confirmed: false, completed: true, price_id: pr1.id)
